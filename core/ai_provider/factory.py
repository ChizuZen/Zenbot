#
# /chizu/core/ai_provider/factory.py
#
...
class FreeAIProvider:
    def __init__(self):
        ...
        # LOCAL=S no .env do iMac isola o teste apenas no Ollama.
        # Em produção (Oracle Cloud), o .env não existe → getenv retorna
        # vazio → o padrão seguro é a lista completa de fallback acima.
